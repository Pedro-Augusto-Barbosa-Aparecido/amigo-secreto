    ...
    return (
        <main className="w-full h-with-nav">
            <div className="w-full h-full">
                <Image 
                    src={"/imgs/500-image-opt-one.jpg"}
                    layout="fill"
                    objectFit="fill"
                    priority
                />
                <div className="absolute text-white font-istok-web p-16 w-full flex flex-col h-with-nav">
                    <div className="text-white text-6xl mb-16">
                        <span>Código </span>
                        <span className="text-dark-orange-600 font-bold">500!</span>
                    </div>
                    <p className="text-3xl w-5/12">
                        Desculpe por esse incômodo. Aconteceu algo com o nosso servidor ou você foi desconectado, verifique sua rede e tente mais tarde.
                    </p>
